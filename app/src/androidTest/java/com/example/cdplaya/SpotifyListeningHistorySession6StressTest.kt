...
class SpotifyListeningHistorySession6StressTest {
    ...
    fun hundredThousandHighReuse_importReimportLaterExportAnalyticsAndBackup() = runBlocking {
        ...
        lateinit var initialResult: com.example.cdplaya.data.importing.ListeningImportExecutionResult
        ...
        lateinit var backup: com.example.cdplaya.data.backup.BackupListeningHistoryV2
        ...
        lateinit var repeatResult: com.example.cdplaya.data.importing.ListeningImportExecutionResult
        ...
        lateinit var laterResult: com.example.cdplaya.data.importing.ListeningImportExecutionResult
    ...
    fun fiveHundredThousandUnique_previewCompletesWithinObservedHeap() = runBlocking {
        ...
        lateinit var preview: com.example.cdplaya.data.importing.spotify.SpotifyListeningHistoryImportPreview
        val elapsed = try {
            measureTimeMillis {
