...
import io.github.rsgarrido.sazanami.data.importing.ImportOccurrenceDecision
...
import io.github.rsgarrido.sazanami.data.importing.ListeningImportChunkResult
import io.github.rsgarrido.sazanami.data.importing.ListeningImportIdentityResolution
import io.github.rsgarrido.sazanami.data.importing.PreparedListeningOccurrence
import io.github.rsgarrido.sazanami.data.importing.spotify.SpotifyImportedEventMapper
...
import io.github.rsgarrido.sazanami.data.local.LegacyListeningBaselineDao
import io.github.rsgarrido.sazanami.data.local.LegacyListeningBaselineEntity
import io.github.rsgarrido.sazanami.data.local.ListeningEventDao
import io.github.rsgarrido.sazanami.data.local.ListeningEventEntity
import io.github.rsgarrido.sazanami.data.local.ListeningTrackIdentityDao
import io.github.rsgarrido.sazanami.data.local.ListeningTrackIdentityEntity
import io.github.rsgarrido.sazanami.data.local.LocalTrackBindingDao
...
import io.github.rsgarrido.sazanami.data.local.ListeningImportBatchEventEntity
...
import io.github.rsgarrido.sazanami.data.local.requireCompatibleWith
import io.github.rsgarrido.sazanami.data.local.requireSupportedExternalSource
import io.github.rsgarrido.sazanami.data.local.requireSupportedImportSource
import io.github.rsgarrido.sazanami.data.local.requireSupportedSemantics
...
class ListeningImportRepository(
    ...
    suspend fun findExternalId(source: io.github.rsgarrido.sazanami.data.local.ListeningSource, externalId: String) =
    ...
    suspend fun persistSpotifyChunk(
        ...
        return database.withTransaction {
            ...
            existingEvidence.forEach { evidence ->
                ...
                require(existingEvent.publicationState != io.github.rsgarrido.sazanami.data.local.ListeningEventPublicationState.IMPORT_PENDING) {
