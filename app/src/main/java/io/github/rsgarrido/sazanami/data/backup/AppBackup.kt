...
data class BackupPreferences(
    ...
    val modernSeekbarColorMode: String = "white",
    val modernBackgroundStyle: String = "blurred_artwork",
    val modernBlurStrength: String = "medium",
    val modernDimmingStrength: String = "medium",
    val modernSolidColorArgb: Long = 0xFF17191F,
    val modernArtworkShape: String = "rounded",
    val modernArtworkSize: String = "standard",
    val modernArtworkFit: String = "crop",
    val modernArtworkShadow: String = "soft",
    val modernControlStyle: String = "glass",
    val modernControlSize: String = "standard",
    val modernControlAccent: String = "white",
    val modernLayoutDensity: String = "balanced",
    val modernMetadataAlignment: String = "left",
    val modernShowAudioQualityBadge: Boolean = true,
...
data class BackupSmartPlaylistDefinition(
    ...
    val rules: List<io.github.rsgarrido.sazanami.data.SmartPlaylistRule> = emptyList(),
